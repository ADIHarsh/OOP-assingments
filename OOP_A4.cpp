//Q  >> WAP to show every concepts of Object oriented programing 
#include<iostream>
using namespace std;
...
void result(Template a, Template b, int c)
{
	if(c==0)
	cout<<" Result after final calculation : "<<(a*b);
	else
	cout<<" Result after final calculation : "<<(a/b);
}
